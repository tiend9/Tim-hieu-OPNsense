...
## III. `Bước 3`: Yêu cầu Network cho VM (Request to Neutron)
...
## V. `Bước 5`:Yêu cầu image cho VM (Request to Glance)
...
## VII. `Bước 7`: Cập nhật trạng thái VM
